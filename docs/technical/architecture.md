...
| `report` | Relatórios |
| `smoke-tests-playground` | Playground de smoke tests |
| `spc-sdk` | Integração SPC |
...
- Autenticação e autorização são tratadas pelos módulos `controleonline/users` e `controleonline/multi-tenancy`.
