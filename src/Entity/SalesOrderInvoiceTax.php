...
class SalesOrderInvoiceTax
{
    ...
    private $id;
    /**
     * @var \App\Entity\SalesInvoiceTax
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\SalesInvoiceTax", inversedBy="order")
     * @ORM\JoinColumns({
     ...
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\SalesOrder", inversedBy="invoiceTax")
     * @ORM\JoinColumns({
     ...
     * Set invoiceTax
     *
     * @param \App\Entity\SalesInvoiceTax $invoice_tax
     * @return SalesOrderInvoiceTax
     */
    public function setInvoiceTax(\App\Entity\SalesInvoiceTax $invoice_tax = null)
    {
